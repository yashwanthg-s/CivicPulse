-- Priority Queue System for Department-Level Complaint Management (FIXED VERSION)
-- This adds priority scoring and queue management capabilities
-- Fixed: Removed triggers that cause "Can't update table in trigger" error
...
-- 4. SLA Configuration by Category
...
BEGIN
  ...
  -- Update complaint with scores (using direct UPDATE, not in trigger)
  UPDATE complaints
  SET 
...
-- Success message
SELECT 'Priority Queue System installed successfully!' as status;
